...
public sealed class ViewconeConeOverlay : Overlay
{
    ...
    private Entity<EyeComponent, ViewconeComponent, TransformComponent>? _eyeEntity;
    ...
    protected override bool BeforeDraw(in OverlayDrawArgs args)
    {
        ...
        var enumerator = _ent.AllEntityQueryEnumerator<LerpingEyeComponent, EyeComponent, ViewconeComponent, TransformComponent>();
